var canvas = document.getElementById("myCanvas");
        ...
        var blocks = [];
        var move = false;
        var colorArr = ["#BDB76B", "#FFFFBB", "#FFDDAA", "#FFAA33", "#FF7744", "#FF3333", "#FF0000", "#FFCC22", "#FF8800", "#FFFF33", "gold", "goldenrod", "orangered"];
        var imageObj = [];
        ...
        function drawBlocks() {
            for (var c = 0; c < col; c++) {
                for (var r = 0; r < row; r++) {
                    ...
                    ctx.fillStyle = "black";
                    if (blocks[c][r].val != 1)
                        ctx.fillText(blocks[c][r].val, brickX + 50, brickY + 60);
                    ctx.closePath();
                }
            }
        }
